                ...
                doccument
                  ...
                  .map((user, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        <a
                          href={`${ImagebaseURL}${user.pictures}`} // Assuming this is the correct path to the file
                          target="_blank"
          ...
          {selectedUser && (
            <DialogContent dividers={false}>
              <Box sx={{ display: 'flex', flexDirection: 'column', mb: 2 }}>
                {/* <TableCell>
                  <a
                    href={`${ImagebaseURL}${selectedUser.pictures}`} // Assuming this is the correct path to the file
                    target="_blank"
                    rel="noopener noreferrer"
                    download
                  >
