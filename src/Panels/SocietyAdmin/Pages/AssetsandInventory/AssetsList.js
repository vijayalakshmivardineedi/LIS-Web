...
const AssetsList = () => {
    ...
    const handleEditClick = () => {
        handleMenuClose();
        navigate(`/societyAdmin/editAssets/${selectedUser.assetId}`);
    };
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, mt: 2 }}>
                    ...
                    /> */}
                        <Button
                            ...
                            onClick={() => navigate("/societyAdmin/addAssets")}
                        >
                            ADD
                        </Button>
                    </Box>
                                ...
                                {Array.isArray(Assetlist) && Assetlist
                                    ...
                                    .map((Assetlist) => (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <img
                                                    src={`${ImagebaseURL}${Assetlist.image}`}
                        ...
                        {selectedUser && (
                            <>
                                <Box sx={{ display: "flex", justifyContent: "center", marginTop: 2, marginBottom: 2 }}>
                                    <img
                                        src={`${ImagebaseURL}${selectedUser.image}`}
