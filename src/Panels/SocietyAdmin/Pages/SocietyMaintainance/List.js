...
const List = () => {
    ...
    const handleEditClick = () => {
        handleMenuClose();
        navigate(`/societyAdmin/payMaintainance/${selectedUser.blockno}/${selectedUser.flatno}/${monthAndYear}`);
    };
    const handleStatusClick = () => {
        handleMenuClose();
        navigate(`/societyAdmin/status/${selectedUser.blockno}/${selectedUser.flatno}/${monthAndYear}`);
    };
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, mt: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                        <Button
                            ...
                            onClick={() => navigate('/societyAdmin/addMontlyMaintainance')}
                        >
                            Add Month
                        </Button>
                    </Box>
                                    ...
                                    {Array.isArray(maintainance) && maintainance
                                        ...
                                        .map((maintainance) => (
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <img
                                                        src={`${ImagebaseURL}${maintainance.pictures}`}
