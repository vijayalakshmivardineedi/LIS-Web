...
import { fetchUsers, deleteUser } from './ListSlice';
...
const Lis5t = () => {
    ...
    const handleView = () => {
        handleMenuClose();
        navigate(`/societyAdmin/view/${selectedUser.userId}`);
    };
            ...
            <Box>
                ...
                <TableContainer component={Paper}>
                    <Table>
                        <TableHead>
                            <TableRow>
                                <TableCell sx={{ fontFamily: "Red Hat Display,sans-serif", fontWeight: 600, fontSize: 16 }}>UserId</TableCell>
                            ...
                            {users
                                ...
                                .map((user, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>
                                            <img
                                                src={`${ImagebaseURL}${user.profilePicture}`}
                                                alt={user.name}
