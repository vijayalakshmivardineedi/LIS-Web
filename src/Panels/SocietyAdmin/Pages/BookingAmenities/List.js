...
const List = () => {
    ...
    const handleEditClick = () => {
        handleMenuClose();
        navigate(`/societyAdmin/editBookings/${Allbooking._id}/${selectedUser.userId}`);
    };
        ...
        <ThemeProvider theme={theme}>
            <Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, mt: 2 }}>
                    ...
                    /> */}
                        <Button
                            ...
                            onClick={() => navigate(`/societyAdmin/addBookings/${Allbooking._id}`)}
                        >
                            Book Community Hall
                        </Button>
                    </Box>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 3, marginBottom: 2 }}>
                        <img
                            src={`${ImagebaseURL}${Allbooking.image}`}
