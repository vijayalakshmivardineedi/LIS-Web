...
import image from "../../../../assets/Images/SocietyAdmin/ad.jpg"
...
const List = () => {
    ...
    const handleView = () => {
        handleMenuClose();
        navigate(`/societyAdmin/view/Adds/${selectedAdd._id}`);
    };

    const handleEditClick = () => {
        handleMenuClose();
        navigate(`/societyAdmin/edit/Adds/${selectedAdd._id}`);
    };
            ...
            <Box >
                ...
                /> */}
                        <Button
                            ...
                            onClick={() => navigate('/societyAdmin/add/Adds')}
                        >
                            ADD
                        </Button>
                    </Box>
                                ...
                                adds
                                    ...
                                    .map((user, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>
                                            <img
    src={user.pictures[0]?.img ? `${ImagebaseURL}${user.pictures[0].img}` : {image}}
    alt={user.name}
