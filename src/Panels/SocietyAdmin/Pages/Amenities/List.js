...
const List = () => {
    ...
    const amenities = useSelector(state => state.amenitieslist.amenities || []);
...
console.log(successMessage)
    ...
    const handleView = () => {
        handleMenuClose();
        navigate(`/societyAdmin/viewAminity/${selectedAmenity._id}`);
    };

    const handleEditClick = () => {
        handleMenuClose();
        navigate(`/societyAdmin/editAminity/${selectedAmenity._id}`);
    };
            ...
            <Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, mt: 2 }}>
                    ...
                    <Button
                        ...
                        onClick={() => navigate('/societyAdmin/addAminity')}
                    >
                        ADD
                    </Button>
                </Box>
