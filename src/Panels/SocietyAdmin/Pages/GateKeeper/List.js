...
const List = () => {
    ...
    const handleView = () => {
        handleMenuClose();
        navigate(`/societyAdmin/gatekeeper/view/${selectedUser.sequrityId}`);
    };

    const handleEditClick = () => {
        handleMenuClose();
        navigate(`/societyAdmin/gatekeeper/edit/${selectedUser.sequrityId}`);
    };
    const handleAttendanceClick = () => {
        handleMenuClose();
        navigate(`/societyAdmin/gatekeeper/attandance/${selectedUser.sequrityId}`);
    };
            ...
            <Box >
                ...
                /> */}
                        <Button
                            ...
                            onClick={() => navigate('/societyAdmin/gatekeeper/add')}
                        >
                            ADD
                        </Button>
                    </Box>
