...
const List = () => {
  ...
  const handleViewClick = () => {
    handleMenuClose()
    navigate(`/societyAdmin/viewEvent/${selectedUser._id}`)
  }

  const handleEditClick = () => {
    handleMenuClose()
    navigate(`/societyAdmin/editEvent/${selectedUser._id}`)
  }
        ...
        >
          ...
          >
            <Button
              ...
              onClick={() => navigate('/societyAdmin/AddEvent')}
            >
              ADD
            </Button>
          </Box>
                      ...
                      >
                        ...
                        <TableCell>
                          ...
                          {resident.pictures &&
                            ...
                            <img
                              src={`${ImagebaseURL}${resident.pictures[0].img}`}
                              alt={resident.name}
                              style={{
                                width: '40px',
                                height: '40px',
