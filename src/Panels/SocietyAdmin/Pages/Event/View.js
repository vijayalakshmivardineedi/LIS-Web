                    ...
                    <Grid container spacing={2}>
                        ...
                        <Box sx={{ marginLeft: 2, padding: '15px', border: '1px solid lightgrey', width: '100%', mb: 2 }}>
                            ...
                            <Grid container spacing={2} mt={1}>
                                ...
                                <Grid item xs={12} sm={6} md={4}>
                                    <Typography variant="body1" sx={{ fontFamily: 'Red Hat Display, sans-serif', fontSize: 18, fontWeight: 600 }}>Start Date</Typography>
                                    <Typography variant="body1">{event.startDate}</Typography>
                                </Grid>
                                <Grid item xs={12} sm={6} md={4}>
                                    <Typography variant="body1" sx={{ fontFamily: 'Red Hat Display, sans-serif', fontSize: 18, fontWeight: 600 }}>End Date</Typography>
                                ...
                                {event.activities && event.activities.map((activity) => (
                                    <Grid item xs={12} sm={6} md={4} key={activity._id}>
                                        <Box sx={{ padding: '10px', border: '1px solid lightgrey', borderRadius: '8px' }}>
                                            ...
                                            <Typography variant="h6" sx={{ fontFamily: 'Red Hat Display, sans-serif', fontSize: 18, fontWeight: 600 }}>Start Date</Typography>
                                            <Typography variant="body1">{activity.startDate}</Typography>
                                            <Typography variant="h6" sx={{ fontFamily: 'Red Hat Display, sans-serif', fontSize: 18, fontWeight: 600 }}>End Date</Typography>
