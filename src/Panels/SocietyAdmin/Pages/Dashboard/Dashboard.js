...
const Dashboard = () => {
    ...
    const handleNavigation = (category) => {
        ...
        if (category === 'Notice') {
            navigate('/societyAdmin/notice');
        } else if (category === 'Event') {
            navigate('/societyAdmin/event');
        }
    };
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Card
                                ...
                                onClick={() => navigate('/societyAdmin/userManagement')}>
                                <CardContent>
                                    <Typography variant="h6" component="div" sx={{ fontWeight: 600, color: "#fff", fontFamily: "Red Hat Display, sans-serif", }}>
                                        Flats
                                    </Typography>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Card
                                ...
                                onClick={() => navigate('/societyAdmin/gatekeeper/list')}>
                                <CardContent>
                                    <Typography variant="h6" component="div" sx={{ fontWeight: 600, color: "#fff", fontFamily: "Red Hat Display, sans-serif" }}>
                                        Guards
                                    </Typography>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Card
                                ...
                                onClick={() => navigate('/societyAdmin/staffMember')}>
                                <CardContent>
                                    <Typography variant="h6" component="div" sx={{ fontWeight: 600, color: "#fff", fontFamily: "Red Hat Display, sans-serif", }}>
                                        Staff
                                    </Typography>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Card
                                ...
                                onClick={() => navigate('/societyAdmin/complaints')}>
                                <CardContent>
                                    <Typography variant="h6" component="div" sx={{ fontWeight: 600, color: "#fff", fontFamily: "Red Hat Display, sans-serif", }}>
                                        Complaints
                                    </Typography>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Card
                                ...
                                onClick={() => navigate('/societyAdmin/notice')}>
                                <CardContent>
                                    <Typography variant="h6" component="div" sx={{ fontWeight: 600, color: "#fff", fontFamily: "Red Hat Display, sans-serif" }}>
                                        Notices
                                    </Typography>
                            ...
                            <Box sx={{
                                ...
                                <Grid sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    ...
                                    <Typography
                                        ...
                                        onClick={() => navigate('/societyAdmin/visitorRecord')}>
                                        View All
                                    </Typography>
                                </Grid>
                                <PieChart />
                                ...
                                {Array.isArray(fetchedAdds) && fetchedAdds.length > 0 ? (
                                    fetchedAdds.map((user, index) => (
                                        <Box key={index} sx={{
                                            ...
                                            onClick={() => navigate('/societyAdmin/addsList')}
                                        >
                                            <img
                                                src={`${ImagebaseURL}${user.pictures[0]}`}
                                                alt={user.name}
                                                style={{
                                                    width: '100%',
                                                    height: '85%',
                        ...
                        <Grid item md={12}>
                            ...
                            >
                                ...
                                <Box sx={{ display: 'flex', justifyContent: "space-around", marginTop: 1 }}>
                                    ...
                                    <Typography variant="body2" sx={{ fontFamily: "Red Hat Display, sans-serif", fontWeight: "600", cursor: 'pointer' }}
                                        onClick={() => navigate('/societyAdmin/event')}>
                                        🔵 Event
                                    </Typography>
                                </Box>
                                <Calender />
