            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    <SidebarTab
                        ...
                        primary="Dashboard"
                        route="/societyAdmin/dashboard"
                    />
                    <SidebarTab
                        icon={<RiAdvertisementFill />}
                        primary="Advertisements"
                        route="/societyAdmin/addsList"
                    />
                    <SidebarTab
                        icon={<IoLayers />}
                        primary="Residential Unit"
                        route="/societyAdmin/residents"
                    />
                    <SidebarTab
                        icon={<FaUsers />}
                        primary="User Management"
                        subMenuItems={[
                            { icon: <MdSupervisorAccount />, primary: "Members", route: "/societyAdmin/userManagement" },
                            { icon: <HiMiniUserGroup />, primary: "Staff Members", route: "/societyAdmin/staffMember" },
                            { icon: <GiOpenGate />, primary: "Security", route: "/societyAdmin/gatekeeper/list" },
                            { icon: <FaUsersGear />, primary: "Committee Members", route: "/societyAdmin/userManagement/committee" },
                        ]}
                    />
                    <SidebarTab
                        icon={<HiClipboardDocumentList />}
                        primary="Documents"
                        route="/societyAdmin/documents"
                    />
                    <SidebarTab
                        icon={<RiDiscussFill />}
                        primary="Discussions"
                        route="/societyAdmin/discussions"
                    />
                    <SidebarTab
                        icon={<BiSolidMessageAltError />}
                        primary="Complaints"
                        route="/societyAdmin/complaints"
                    />
                    <SidebarTab
                        icon={<FaPersonCircleCheck />}
                        primary="PassageWay Record"
                        subMenuItems={[
                            { icon: <MdPersonPin />, primary: "Visitor Record", route: "/societyAdmin/visitorRecord" },
                            { icon: <MdPersonPinCircle />, primary: "Staff Record", route: "/societyAdmin/staffRecord" },
                        ]}
                    />
                    <SidebarTab
                        ...
                        primary="Notices"
                        subMenuItems={[
                            { icon: <MdNotificationAdd />, primary: "Notice Board", route: "/societyAdmin/notice" },
                            { icon: <BiSolidCalendarEvent />, primary: "Events", route: "/societyAdmin/event" },
                    ...
                    <SidebarTab
                        ...
                        subMenuItems={[
                            { icon: <MdPool />, primary: "Amenities", route: "/societyAdmin/amenities" },
                            { icon: <IoMdBookmarks />, primary: "Booking Hall", route: "/societyAdmin/bookings" },
                        ]}
                    />
                    <SidebarTab
                        icon={<GiToolbox />}
                        ...
                        subMenuItems={[
                            { icon: <SiSmartthings />, primary: "Assets", route: "/societyAdmin/assets" },
                            { icon: <MdInventory />, primary: "Inventory", route: "/societyAdmin/inventory" },
                        ]}
                    />
                    <SidebarTab
                        icon={<MdPayments />}
                        primary="Accounts"
                        subMenuItems={[
                            { icon: <IoDocumentsSharp />, primary: "Society Bills", route: "/societyAdmin/societyBills" },
                            { icon: <SiCashapp />, primary: "Maintenance", route: "/societyAdmin/maintainance" },
                        ]}
                    />
