...
import { logout } from "../../../Redux/Slice/Website/LoginSlice";
...
const Header = () => {
    ...
    const handleLogout = async () => {
        ...
        try {
            ...
            if (result.type === "societyAdmin/logout") {
                navigate("/")
            }
        } catch (error) {
            console.log(error)
    ...
    const handleSettings = () => {
        handleClose4();
        navigate("/societyAdmin/settings")
        ...
        <Box sx={{
            ...
            <Box>
                ...
                <Menu
                    ...
                    sx={{ marginTop: 2 }}
                >
                    <MenuItem onClick={() => navigate("/societyAdmin/profile")} sx={{ borderBottom: "1px solid #ccc" }}>Profile</MenuItem>
